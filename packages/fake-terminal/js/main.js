...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "This website will host my artwork that I have dedicated to the PhD. Please Enjoy :)",
        "getting_started.txt": "Where to begin?",
        "personal_contact.txt": "sharifsuliman1@gmail.com",
        "phd.txt": "Just a placeholder for now"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
